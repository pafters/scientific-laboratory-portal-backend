...
return static function (): void {
    ...
    #ADMIN_URL# - адрес страницы пользователя
    #DEFAULT_EMAIL_FROM# - адрес электронной почты сервера
    #EMAIL_TO# - адрес электронной почты модератора
    #SERVER_NAME# - название сайта
    DESCRIPTION;

    $typeResult = EventTypeTable::add([
        'DESCRIPTION' => $description,
        'EVENT_NAME' => 'NEW_USER_MODERATION',
        'EVENT_TYPE' => EventTypeTable::TYPE_EMAIL,
        'LID' => 'ru',
        'NAME' => 'Запрос модерации нового пользователя',
        'SORT' => 10,
    ]);
    ...
    На сайте #SERVER_NAME# зарегистрировался новый пользователь.

    Проверьте его данные и активируйте либо заблокируйте его.

    Данные пользователя: #ADMIN_URL#
    ...
    $messageResult = EventMessageTable::add([
        ...
        'REPLY_TO' => '',
        'SITE_TEMPLATE_ID' => '',
        'SUBJECT' => '#SITE_NAME#: Зарегистрировался новый пользователь, требуется модерация',
    ]);
